...
description: Privacy policy for Chad Cycling Coach.
---

<section class="section-block" id="top">
	...
	<div class="hero-actions">
		<a class="button button-primary" href="{{ '/' | relative_url }}">Back to the main site</a>
	</div>
</section>